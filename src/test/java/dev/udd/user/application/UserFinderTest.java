...
final public class UserFinderTest {
    ...
    @Test
    public void whenUserNotFoundShouldThrowUserNotFound() throws UserNotFound, UserValueInvalid {
    ...
    @Test
    public void whenInvalidArgumentShouldThrowUserValueInvalid() throws UserNotFound, UserValueInvalid {
